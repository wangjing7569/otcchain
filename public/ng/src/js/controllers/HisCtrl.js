app.controller('HisCtrl', ['$scope','$localStorage','$state','HttpService','REST_URL','$modal','DialogService','$q', function($scope, $localStorage, $state,HttpService,REST_URL,$modal,DialogService,$q) {
    ...
    function render() {
       ...
       HttpService.post(REST_URL.query1, {fcn: "queryHis1", args:[$localStorage.loginuser.cmId]}).then(function (response) {
        ...
        HttpService.post(REST_URL.query1, {fcn: "queryHis2", args:[$localStorage.loginuser.cmId]}).then(function (response) {
