app.controller('PublishBillCtrl', ['$scope', '$rootScope', '$http', '$modal', '$log', 'REST_URL', 'HttpService', 'DialogService', '$localStorage', '$state', '$stateParams',
    function ($scope, $rootScope, $http, $modal, $log, REST_URL, HttpService, DialogService, $localStorage, $state, $stateParams) {
        ...
        $scope.item = {};
        $scope.item.BillInfoID = '';
        $scope.item.BillInfoAmt = '';
        $scope.item.BillInfoType = '';
        $scope.item.BillInfoIsseDate = '';
        $scope.item.BillInfoDueDate = '';
        $scope.item.DrwrCmID = '';
        $scope.item.DrwrAcct = '';
        $scope.item.AccptrCmID = '';
        $scope.item.AccptrAcct = '';
        $scope.item.PyeeCmID = '';
        $scope.item.PyeeAcct = '';
