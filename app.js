...
app.post('/channels/mychannel/chaincodes/otcc/invoke', function(req, res) {
    logger.debug('==================== INVOKE ON CHAINCODE ==================');
    var peers = req.body.peers;
    var chaincodeName = "otcc";
...
app.post('/channels/mychannel/chaincodes/commute/invoke', function(req, res) {
    logger.debug('==================== INVOKE ON CHAINCODE ==================');
    var peers = req.body.peers;
    var chaincodeName = "commute";
    var channelName = "mychannel";
    var fcn = req.body.fcn;
    var args = req.body.args;
    logger.debug('channelName  : ' + channelName);
